...
const categories: Array<{
...
}> = [
  {
    ...
    guides: [
      ...
      { title: 'Matrícula especial', meta: 'Presencial · 15 días', description: 'Solicita autorización después del cierre de las matrículas extraordinarias.', href: 'https://estliveupsedu-my.sharepoint.com/:w:/g/personal/labautomotrizuio_ups_edu_ec/IQBvc2QR0eiBQoP7P_zoxZ2ZAUlyUTfdZD03YXPnPacOAyw?e=yGaB8B', icon: CalendarCheck },
      { title: 'Matrícula como condicionado oyente', meta: 'Tercera matrícula', description: 'Trámite obligatorio cuando cursarás una asignatura por tercera ocasión.', href: 'https://estliveupsedu-my.sharepoint.com/:w:/g/personal/labautomotrizuio_ups_edu_ec/IQAZENM0DrbWSa3Dpd_TpvXGAZOTWTmlOrjcPpq6gAekKdA?e=nYiVOM', icon: Ear },
      { title: 'Matrícula con aprobación previa de condicionado oyente', meta: 'Condicionado oyente', description: 'Registra asignaturas de condicionado oyente aprobadas en un período anterior.', href: 'https://estliveupsedu-my.sharepoint.com/:w:/g/personal/labautomotrizuio_ups_edu_ec/IQALDLOTCRY2S62vi8boDbSjAaaWNNKQhfowfCi99XrSVtY?e=xG9QVP', icon: BadgeCheck },
      { title: 'Matrícula después de eliminar la prefactura', meta: 'Falta de pago · Presencial', description: 'Solicita una nueva matrícula cuando la prefactura inicial fue eliminada.', href: 'https://estliveupsedu-my.sharepoint.com/:w:/g/personal/labautomotrizuio_ups_edu_ec/IQBkJeuwCxTXQJR8rkjlxI_1AZ6o26WNjXJLOb5Kqqb8BH0?e=YkYQFJ', icon: Receipt },
      { title: 'Reingreso a la carrera', meta: 'En línea · Primer mes', description: 'Orientación para retomar la carrera dentro del plazo institucional.', href: 'https://estliveupsedu-my.sharepoint.com/:w:/g/personal/labautomotrizuio_ups_edu_ec/IQBZEodcGc-ISbXO4w6lZV58AV8nAjkMQCHCCj5xb4XUB5k?e=UKo3gX', icon: RotateCcw },
    ],
  },
  {
